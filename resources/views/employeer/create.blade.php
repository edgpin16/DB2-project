        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-md-6 text-center">
                    <h5 class="display-5 mb-3" >Crear un nuevo empleado</h5>
                        ...
                        <div class="form-group form-control-lg mb-5">
                            ...
                            <select class="input-group mb-3" name= "type_category" id="type_category">
                                ...
                                <option 
                                    ...
                                    {{request()->path() === 'empleado/crear/administrativo' ? 'selected' : 'disabled'}}
                                >
                                    Administrativo
                                </option>
                                ...
                                <option 
                                    ...
                                    {{request()->path() === 'empleado/crear/auxiliarFarmacia' ? 'selected' : 'disabled'}}
                                >
                                ...
                                <option 
                                    value="Analyst"        
                                    {{request()->path() === 'empleado/crear/analista' ? 'selected' : 'disabled'}}                     
                                >
                                    Analista
                                </option>
                            </select>
