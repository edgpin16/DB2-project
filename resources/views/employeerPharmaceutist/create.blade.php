...
@section('title', 'Crear empleado farmaceútico')
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-md-6 text-center">
                    <h5 class="display-5 mb-3" >Crear un empleado farmaceútico</h5>
                    <form action=" {{route('employeerPharmaceutist.store')}} " method="post"> 
                        @csrf
                        ...
                        <div class="form-group form-control-lg mb-5">
                            ...
                            <input type="number" name="sanitary_permise_number" id="sanitary_permise_number" 
                                class="form-control"
                                value="{{ old('sanitary_permise_number') }}" 
